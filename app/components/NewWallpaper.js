      ...
      <div className="relative overflow-hidden rounded-2xl bg-gradient-to-br from-accent/20 to-accent/5 border border-border p-8 md:p-12">
        <div className="relative z-10">
          ...
          <h1 className="text-3xl md:text-5xl font-black tracking-tight text-primary">
            New <span className="text-accent">Wallpapers</span>
          </h1>
          <p className="text-muted text-lg mt-3 max-w-xl">
            Browse the latest high-resolution backgrounds added to our collection.
          </p>
        </div>
        ...
        <>
          ...
          {!loading && images.length === 0 && (
            <div className="text-center py-16">
              ...
              <p className="text-muted text-lg font-medium">No new wallpapers yet</p>
              <p className="text-muted text-sm mt-1">Check back soon for fresh uploads</p>
            </div>
          )}
