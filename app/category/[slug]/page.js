    ...
    <div className="p-6 bg-background text-primary">
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-6">
        {categoryWallpapers.map((wallpaper, index) => (
          <div
            key={wallpaper.id}
            className="group bg-surface rounded-lg shadow-md border border-border overflow-hidden hover:shadow-lg transition-shadow duration-300"
          >
            ...
            <div className="p-4">
              <h2 className="text-lg font-semibold text-primary">{wallpaper.title}</h2>
              <div className="flex items-center justify-between mt-3">
                ...
                <a
                  ...
                  download
                  className="bg-accent text-accent-foreground text-sm font-medium px-4 py-2 rounded hover:opacity-90 transition-colors"
                >
                  Download
                </a>
              </div>
